...
public class DaoEspaceAdmin implements IDao<Authentification> {

	
	private WebResource webResource;

	public DaoEspaceAdmin(String uri) {
	...
	public ClientResponse get(Integer id) {
		...
		// TODO Auto-generated method stub
		WebResource webResource = this.webResource.path("/espaceAdmin/" + id);
	...
	public ClientResponse get() {
		// TODO Auto-generated method stub
		WebResource webResource = this.webResource.path("/espaceAdmins");
		return get(webResource);
	}
	...
	public ClientResponse post(Authentification t) {
		...
		webResource = this.webResource.path("/espaceAdmin");
		Builder builder = getBuilder (webResource);
	...
	public ClientResponse put(Authentification t) {
		// TODO Auto-generated method stub
		WebResource webResource = addQueryParam (t);
		webResource = this.webResource.path("/espaceAdmin/" + String.valueOf(t.getId()));
		Builder builder = getBuilder (webResource);
